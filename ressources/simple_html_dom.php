...
soit en utilisant le méthode getAttribute() et en précisant le nom de l’attribut comme argument (ex : $e->getAttibute($name);), soit en utilisant un raccourci qui consiste à préciser directement l’attribut que nous souhaitons récupérer (ex : $e->attribute;). Pour l’exemple suivant nous utiliseront la base de code suivante :
