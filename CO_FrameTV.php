...
if ($nuitSalon != 2 && $nbMvmt && (!mg::getCmd($equipSmartThings, 'Sous tension') || !mg::getCmd($equipFrameTV, 'Puissance') < 5)) {
	// =================================================================================================================
...
if (!$cinema && ($nuitSalon == 2 || $lastMvmt > $timingFrameTV) && !mg::getCmd($equipSmartThings, 'Sous tension')) {
	//=================================================================================================================
